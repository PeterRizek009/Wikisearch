...
const About = () => {
    return (
        <>
            <h1 className="text-center mt-5 title">About<span> WIKI Search</span> APP</h1>
            <div className="w-100 mt-5 mx-auto container">
                <div className="about">
                    <div className="item">
                        <h5 className="mx-3">About WIKI Search APP</h5>
                    ...
                    <div className="item">
                        ...
                        <section className="mx-auto" >
                            ...
                            <a className="btn btn-link btn-floating btn-lg text-dark m-1" href="https://www.youtube.com/channel/UC7NM1ljXzljX2suo-Wjjr_w" role="button" data-mdb-ripple-color="dark"><i className="fab fa-youtube" /></a>
                        </section>
                    </div>
